To run server, navigate to the same level where the package.json file is and run `npm start`

Run `npm run build` to create a production ready build (with minified files)
